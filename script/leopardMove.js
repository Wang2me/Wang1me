...
{title_cn: '描述',title_en: 'Description'  
 ,description_cn:'劉安是西漢皇族，被封為淮南王。在他所編著的《淮南子》中曾有圈養虎豹的記載。而《漢書》中也有經過馴服的虎豹可以聽從人類的指令的記載。這些記載說明，豹作為觀賞動物飼養在皇家園林中在漢代是非常流行的。(公元前117年)，霍去病因病去世，年僅二十四歲。霍去病墓位於如今的陝西省興平市，距離埋葬漢武帝的茂陵儘一千米。考古學家在霍去病墓中發掘了超過5000件文物，其中最有代表性的是｢鎏金銅馬｣。這件銅馬長76釐米，高62釐米，重逹26公斤，是以來自大宛的汗血馬為原型製造的。它的出現表明了由中亞地區傳入中國的馬在古代軍事上的重要作用。'  
 ,description_en:''
...
//明
{
markers.leopard13 = createMarker({lat:39.9294449,lng:116.3888 }, 'leopard','北京北海',{ A:['leopard'],B:['明'],C:['文化娛樂'],D:['其他'],E:['東亞'] },
{title_cn: '描述',title_en: 'Description'  
